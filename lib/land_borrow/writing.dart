...
import 'package:project1/firestore/select_image.dart';
import 'package:project1/image_storage.dart';
              ...
              Padding(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () async {
                    ...
                    List<String> downloadUrls = await ImageStorge.uploadImages(images);
                  },
                  child: Text('저장'),
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    IconButton(
                        onPressed: () async {
                          final List<XFile> multiImage = await picker.pickMultiImage();
                          if(multiImage != null) {
                            await context.read<SelectImageNotifier>().setNewImages(multiImage);
                            setState(() {
              ...
              Container(
                ...
                child: GridView.builder(padding: EdgeInsets.all(0),
                  shrinkWrap: true,
                  itemCount: selectImageNotifier.images.length,
                  gridDelegate:
                      ...
                      children: [
                        Container(
                          decoration: BoxDecoration(
                              ...
                              DecorationImage(
                                  fit: BoxFit.cover,
                                  image: FileImage(File(selectImageNotifier.images[index] as String
